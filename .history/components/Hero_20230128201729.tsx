...
export default function Hero({}: Props) {
  ...
  return (
    ...
    className="h-screen pt-24 flex flex-col space-y-8 items-center justify-center text-center overflow-hidden">
      <BackgroundCircles />
      <img
        className="md:relative rounded-full h-32 w-32 mx-auto object-cover"
        src="https://i.ibb.co/ys5QV40/Charan-Jagwani.jpg" alt="" />
      <div className="z-20">
        <h2 className="md:text-sm text-xs text-center uppercase text-[#a8b2d1] pl-3 pb-2 tracking-[15px]">Software Engineer</h2>
