...
export default function About({ }: Props) {
    return (
       ...
       max-w-7xl px-10 mx-auto pt-24">
            ...
            Allocation of Bonds, Savings, and Stocks
            </h3>
            <div className="flex flex-col relative md:flex-row justify-evenly items-center gap-6">
                <motion.img
                    ...
                    className="bg-[#a8d1bb] bg-opacity-20 p-10 md:mb:0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[600px] xl:h-[600px]"
                />
