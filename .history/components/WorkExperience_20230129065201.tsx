...
function WorkExperience({ }: Props) {
  return (
    <motion.div
      ...
      <h3
        className="uppercase tracking-[20px] pl-5 text-gray-500 text-2xl mb-7 pt-[-3rem]"
      >Who Are You?</h3>

      <div className="w-full flex space-x-5 overflow-x-scroll
         p-4 snap-x  snap-mandatory py-0 md:pb-3 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#a8b2d1]/40">
        <ExperienceCard />
        <ExperienceCard1 />
