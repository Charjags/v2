...
export default function ExperienceCard({ }: Props) {
    return <Link href='#hero'><div><button><article className="flex flex-col rounded-lg md:mt-3 items-center space-y-7 flex-shrink-0 sm:w-[600px] xl:w-[786px] snap-center bg-[#292929] mb-9 p-3 pb-3 md:mb-5 md:p-5 md:pb-5 md:hover:opacity-100 md:opacity-80
