                ...
                {projects?.map((project, i) => (
                    <div key={project._id}
                        ...
                        <div className='md:flex md:flex-row'>
                            ...
                            <div className='flex-auto'>
                                <div className='space-y-8 px-0 md:px-10 lg:max-w-xl text-xs sm:pb-5 md:text-base lg:pl-10 lg:pb-4'><span className='text-[#64ffda]'>{project.linkToBuild}</span></div>
