...
export default function ExperienceCard1({}: Props) {
    ...
    [500px] sm:w-[600px] xl:w-[650px] snap-center bg-[#292929] mb-9 p-3 pb-3 md:mb-5 md:p-3 md:pb-3 md:hover:opacity-100 md:opacity-40
     transition-opacity duration-200 overflow-hidden">
        ...
        viewport={{once:true}}
        className="w-24 h-24 md:w-27 md:h-27 rounded-md xl:w-[786px] xl:h-[200px]
 object-center"
