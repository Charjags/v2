...
export default function ExperienceCard({ }: Props) {
    const SmoothScrollLink = ({ children, to, className }) => {
  const linkRef = useRef(null);

  const handleClick = (event) => {
    event.preventDefault();
    const target = linkRef.current.getAttribute("href");
    ...
    [500px] sm:w-[600px] xl:w-[786px] snap-center bg-[#292929] mb-5 p-5 pb-3 md:mb-3 md:p-3 md:pb-3 md:hover:opacity-100 md:opacity-80
     transition-opacity duration-200 overflow-hidden">
        ...
        <div className="px-0 sm:px-10 md:space-y-2">
            ...
            <p className="font-bold sm:text-xl lg:text-2xl nt-1">Short Term, Higher Risk</p>
