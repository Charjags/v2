                    ...
                    <div key={project._id}
                        ...
                        <div className='md:flex md:flex-row'>
                            <div className='flex-auto'>
                                <div className=' text-[#64ffda] pt-[-8rem] md:pb-10 md:pr-24 max-w-xl text-xs sm:pb-4 flex lg:pl-11 lg:mx-auto justify-center text-center invisible md:visible '>
                            ...
                            <div className='flex-auto'>
                                <div className='space-y-10 px-0 md:px-10 lg:max-w-xl text-xs sm:pb-5 md:text-base lg:pl-10 lg:pb-4'><span className='text-[#64ffda]'>{project.linkToBuild}</span></div>
                                    
                                <div className="space-y-8 px-0 md:px-10 max-w-xl flex-col flex">
                                        <DonutChart
                                            data={[
                                                {
                                                label: 'Bonds',
