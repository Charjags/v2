...
export default function ExperienceCard({ }: Props) {
    return <article className="flex flex-col rounded-lg md:mt-3 items-center space-y-7 flex-shrink-0 sm:w-[600px] xl:w-[900px] snap-center bg-[#292929] mb-9 p-3 pb-3 md:mb-5 md:p-3 md:pb-3 md:hover:opacity-100 md:opacity-40
     transition-opacity duration-200 overflow-hidden">
        ...
        object-cover object-center"
            src="https://www.google.com/url?sa=i&url=http%3A%2F%2Fclipart-library.com%2Fcartoon-tortoise-cliparts.html&psig=AOvVaw1N7Nr7Fl8HtZmJwhoMASdv&ust=1675050402126000&source=images&cd=vfe&ved=0CA8QjRxqFwoTCNDp-5Lv6_wCFQAAAAAdAAAAABAE"
            alt=""
        />
