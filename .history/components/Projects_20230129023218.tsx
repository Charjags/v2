                    ...
                    <div key={project._id}
                        ...
                        <div className='md:flex md:flex-row'>
                            <div className='flex-auto'>
                                <div className=' text-[#64ffda] pt-[-8rem] md:pb-10 md:pr-8 max-w-xl text-xs sm:pb-4 flex lg:pl-11 lg:mx-auto justify-center text-center invisible md:visible '>
                                ...
                                <motion.img
                                    ...
                                    viewport={{ once: true }}
                                    className="lg:h-72 lg:w-96 mx-auto mt-[-2rem] pt-[-3rem] hidden md:block"
...
Technology stocks and cryptocurrency [GIVE EXAMPLES HERE] have a very high volatility, allowing for the potential for very high returns.
The volatility and potential for returns can be measured by [BRIEFLY MENTION THE METRICS]
There is nothing wrong with taking more risks, especially if you have the income and financial freedom to support it, 
