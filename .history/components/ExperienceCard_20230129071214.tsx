    ...
    [500px] sm:w-[600px] xl:w-[786px] snap-center bg-[#292929] mb-5 p-5 pb-3 md:mb-3 md:p-3 md:pb-3 md:hover:opacity-120 md:opacity-80
     transition-opacity duration-200 overflow-hidden">
        ...
        <div className="px-0 sm:px-10 md:space-y-2">
            <h4 className="sm:text-2xl md:text-3xl lg:text-4xl text-right text-[#ccd6f6] font-light">High Risk, High Reward</h4>
            <p className="font-bold items-center sm:text-xl lg:text-2xl nt-1">Short Term, Higher Risk</p>
