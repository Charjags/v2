...
export default function ExperienceCard1({}: Props) {
    ...
    [500px] sm:w-[600px] xl:w-[786px] snap-center bg-[#292929] mb-9 p-3 pb-3 md:mb-5 md:p-3 md:pb-3 md:hover:opacity-100 md:opacity-70
     transition-opacity duration-200 overflow-hidden">
        ...
        viewport={{once:true}}
        className="w-24 h-24 md:w-27 md:h-27 rounded-md xl:w-[300px] xl:h-[200px]
 object-center"
            src="https://thumbs.dreamstime.com/z/white-rabbit-cartoon-isolated-transparent-background-illustration-208659754.jpg"
            alt=""
        />

        <div className="px-0 sm:px-10 md:space-y-2">
            <h4 className="sm:text-2xl md:text-3xl lg:text-4xl text-[#ccd6f6] font-light">Google Solution Challenge</h4>
